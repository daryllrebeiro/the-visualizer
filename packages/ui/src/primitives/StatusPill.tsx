...
export type ConnectionStatusType = 'CONNECTED' | 'DISCONNECTED' | 'CONNECTING' | 'RECONNECTING' | 'ERROR' | 'SANDBOX';
...
export const StatusPill: React.FC<StatusPillProps> = ({
  ...
  const getStatusConfig = (): { variant: NonNullable<BadgeProps['variant']>; defaultLabel: string; dot: boolean } => {
    switch (status) {
      case 'CONNECTED':
