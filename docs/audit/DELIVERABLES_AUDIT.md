...
1. **Residual Non-Deterministic Calls in Reducers**:
   ...
   - _Root Cause:_ `golden-determinism.test.ts` tests default tick loops (`runGoldenSequence`), which did not trigger B+Tree splits or RabbitMQ publish paths.
