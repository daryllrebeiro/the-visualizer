...
- **Topic-Specific Filtering**: Consumer group members declare `subscribedTopics`. The coordinator distributes partitions _only_ for the topics a consumer has subscribed to.
